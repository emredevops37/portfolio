...
export default function About() {
  ...
  return (
    <motion.section
      ...
      {language === 'en' ? (
        <p className="mb-3">
          Hi, I'm Emre, a passionate <span className="font-medium">DevOps Engineer</span> with over <span className="font-medium">4 years of experience</span> in the industry. My primary focus is on
